        ...
        <section className="container px-4 md:px-8 max-w-screen-2xl py-12">
            <Tabs defaultValue="overview" className="w-full">
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 bg-muted h-auto">
                    <TabsTrigger value="overview" className="h-12 text-md">Overview</TabsTrigger>
                    <TabsTrigger value="gallery" className="h-12 text-md">Gallery</TabsTrigger>
                    <TabsTrigger value="footage" className="h-12 text-md">Flight Footage</TabsTrigger>
                    <TabsTrigger value="downloads" className="h-12 text-md">Downloads</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="overview" className="mt-8 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            ...
                            <p className="text-muted-foreground">
                                Detailed specs and features regarding the {product.name} platform would go here. 
                                Highlighting the specific engineering decisions made during in-house development.
                            </p>
                        </div>
                    ...
                    <div className="mt-12">
                         <h3 className="text-2xl font-bold mb-6 text-center">Pricing Options</h3>
                         <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            {[
                                { tier: "Open-Source Files", price: "FREE", desc: "STL + STEP + BOM" },
                                { tier: "Frame Pack", price: "$89–99", desc: "Printed PETG + TPU" },
                                { tier: "Electronics Kit", price: "$179–249", desc: "SpeedyBee + motors + VTX" },
                                { tier: "Full BNF", price: "$349–449", desc: "Bind-N-Fly (add RX/batts)" },
                            ].map((tier, i) => (
                ...
                <TabsContent value="gallery" className="mt-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="aspect-square bg-muted rounded-lg grid place-items-center">
                ...
                <TabsContent value="footage" className="mt-8">
                     <div className="aspect-video bg-black rounded-lg grid place-items-center border border-zinc-800">
                        <span className="text-white text-xl">Cinematic Flight Footage Embed</span>
                     </div>
                </TabsContent>
                     ...
                     <Card className="bg-card border-border">
                        <CardContent className="p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div>
                                ...
                                <p className="text-muted-foreground">Get the STL, STEP, and BOM files for the {product.name} frame.</p>
                            </div>
